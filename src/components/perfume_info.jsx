...
const perfume_info = [
    ...
    {
      "name": "Do Son",
      "pic_name": <img className = "perfume" src={Perfume3} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 2); window.location.href = "perdict/#/visual/"}}/>,
      "brand": "Diptyque",
      "price": [131.00, 94.00],
      "volume": [100, 50],
    ...
    },
    {
      ...
      "pic_name": <img className = "perfume" src={Perfume4} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 3); window.location.href = "perdict/#/visual/"}}/>,
      "brand": "Hermes",
    ...
    },
    {
      ...
      "pic_name": <img className = "perfume" src={Perfume5} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 4); window.location.href = "perdict/#/visual/"}}/>,
      "brand": "Hermes",
      "price": [126.00, 84.00],
      "volume": [100, 35],
    ...
    },
    {
      ...
      "pic_name": <img className = "perfume" src={Perfume6} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 5); window.location.href = "perdict/#/visual/"}}/>,
      "brand": "Lancome",
      "price": [133.00, 100.00],
      "volume": [100, 50],
    ...
    {
      "name": "Cherry Blossom",
      "pic_name": <img className = "perfume" src={Perfume7} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 6); window.location.href = "perdict/#/visual/"}}/>,
    ...
    {
      "name": "A La Rose ",
      "pic_name": <img className = "perfume" src={Perfume8} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 7); window.location.href = "perdict/#/visual/"}}/>,
    ...
    },
    {
      ...
      "pic_name": <img className = "perfume" src={Perfume9} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 8); window.location.href = "perdict/#/visual/"}}/>,
      "brand": "Lanvin",
      "price": [30.00, 55.00],
      "volume": [50, 100],
    ...
    {
      "name": "Baccarat Rouge",
      "pic_name": <img className = "perfume" src={Perfume10} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 9); window.location.href = "perdict/#/visual/"}}/>,
      "brand": "Maison Francis Kurkdjian",
      "price": [78.00, 99.00],
      "volume": [70, 100],
    ...
    {
      "name": "Alien",
      "pic_name": <img className = "perfume" src={Perfume11} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 10); window.location.href = "perdict/#/visual/"}}/>,
      "brand": "Mugler",
      "price": [21.00, 35.00],
      "volume": [30, 50],
    ...
    },
    {
      ...
      "pic_name": <img className = "perfume" src={Perfume12} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 11); window.location.href = "perdict/#/visual/"}}/>,
      "brand": "Tom Ford",
      "price": [45.00, 80.00],
      "volume": [50, 100],
    ...
    {
      "name": "Aventus",
      "pic_name": <img className = "perfume" src={Perfume13} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 12); window.location.href = "perdict/#/visual/"}}/>,
      "brand": "Creed",
    ...
    },
    {
      ...
      "pic_name": <img className = "perfume" src={Perfume14} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 13); window.location.href = "perdict/#/visual/"}}/>,
      "brand": "Chanel",
      "price": [32.00, 50.00],
      "volume": [100, 250],
    ...
    {
      "name": "Black Opium",
      "pic_name": <img className = "perfume" src={Perfume15} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 14); window.location.href = "perdict/#/visual/"}}/>,
    ...
    {
      "name": "Black Orchid",
      "pic_name": <img className = "perfume" src={Perfume16} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 15); window.location.href = "perdict/#/visual/"}}/>,
      "brand": "Tom Ford",
      "price": [65.00, 75.00],
      "volume": [40, 50],
    ...
    },
    {
      ...
      "pic_name": <img className = "perfume" src={Perfume17} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 16); window.location.href = "perdict/#/visual/"}}/>,
      "brand": "Yves Sain Laurent",
    ...
    },
    {
      ...
      "pic_name": <img className = "perfume" src={Perfume18} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 17); window.location.href = "perdict/#/visual/"}}/>,
      "brand": "John Varvatos",
      "price": [27.00, 22.00],
      "volume": [100, 50],
    ...
    {
      "name": "Fahrenheit",
      "pic_name": <img className = "perfume" src={Perfume19} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 18); window.location.href = "perdict/#/visual/"}}/>,
    ...
    },
    {
      ...
      "pic_name": <img className = "perfume" src={Perfume20} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 19); window.location.href = "perdict/#/visual/"}}/>,
    ...
    {
      "name": "Sailing Day",
      "pic_name": <img className = "perfume" src={Perfume21} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 20); window.location.href = "perdict/#/visual/"}}/>,
    ...
    {
      "name": "Snow Mint",
      "pic_name": <img className = "perfume" src={Perfume22} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 21); window.location.href = "perdict/#/visual/"}}/>,
    ...
    },
    {
      ...
      "pic_name": <img className = "perfume" src={Perfume23} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 22); window.location.href = "perdict/#/visual/"}}/>,
      "brand": "Bvlgari",
      "price": [45.00, 80.00],
      "volume": [50, 100],
    ...
    },
    {
      ...
      "pic_name": <img className = "perfume" src={Perfume24} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 23); window.location.href = "perdict/#/visual/"}}/>,
      "brand": "Guerlain",
      "price": [32.00, 50.00],
      "volume": [100, 250],
    ...
    },
    {
      ...
      "pic_name": <img className = "perfume" src={Perfume25} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 24); window.location.href = "perdict/#/visual/"}}/>,
      "brand": "Victoria's Secret",
      "price": [21.00, 35.00],
      "volume": [30, 50],
    ...
    },
    {
      ...
      "pic_name": <img className = "perfume" src={Perfume26} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 25); window.location.href = "perdict/#/visual/"}}/>,
      "brand": "Prada",
      "price": [126.00, 84.00],
      "volume": [100, 35],
    ...
    {
      "name": "Radish Vetiver ",
      "pic_name": <img className = "perfume" src={Perfume27} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 26); window.location.href = "perdict/#/visual/"}}/>,
    ...
    {
      "name": "Dry Wood Ramon",
      "pic_name": <img className = "perfume" src={Perfume28} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 27); window.location.href = "perdict/#/visual/"}}/>,
      "brand": "Mogegal",
      "price": [164.00, 104.00],
      "volume": [70, 35],
    ...
    {
      "name": "Honey Oud",
      "pic_name": <img className = "perfume" src={Perfume29} alt = "" onClick = {() => {localStorage.setItem('perfume_id', 28); window.location.href = "perdict/#/visual/"}}/>,
      "brand": "Floris",
      "price": [45.00, 80.00],
      "volume": [50, 100],
